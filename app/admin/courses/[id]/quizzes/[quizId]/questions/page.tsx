...
export default async function QuizQuestionsPage({ params }: { params: { id: string; quizId: string } }) {
  ...
  return (
    <div className="container py-10">
      <div className="flex items-center gap-2 mb-8">
        <Link href={`/admin/courses/${params.id}/quizzes`}>
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <Link href={`/admin/courses/${params.id}/quizzes/${params.quizId}/questions/create`}>
          ...
          questions.map((question, index) => (
            <Card key={question.id}>
                  ...
                  {question.options.map((option: string, optionIndex: number) => (
                    <div
                      ...
                      className={`p-3 rounded-md border ${
                        optionIndex === question.correct_answer ? "bg-green-50 border-green-200" : "bg-muted/50"
                      }`}
                    >
                      <div className="flex items-center gap-2">
                        ...
                        {optionIndex === question.correct_answer && (
                          <span className="ml-auto text-sm text-green-600 font-medium">Correct Answer</span>
                        )}
                      </div>
                    </div>
                  ))}
              ...
              <CardFooter className="flex justify-end gap-2">
                <Link href={`/admin/courses/${params.id}/quizzes/${params.quizId}/questions/${question.id}/edit`}>
