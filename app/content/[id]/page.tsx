    ...
    <AppShell>
      <div className="space-y-6">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-2xl font-bold tracking-tight animate-fade-in">{content.title}</h1>
        ...
        <Card className="animate-fade-in" style={{ animationDelay: "0.1s" }}>
          <CardHeader>
            <div className="flex justify-between items-start">
              <div>
                ...
                <CardDescription>
                  {content.type.charAt(0).toUpperCase() + content.type.slice(1)} • {content.language}
          ...
          <CardContent className="space-y-4">
            <div className="prose max-w-none dark:prose-invert">
              ...
              {content.content_html && <div dangerouslySetInnerHTML={{ __html: content.content_html }} />}
            </div>
            ...
            {progress && (
              <div className="mt-4">
                ...
                <div className="progress-bar">
                  <div className="progress-bar-fill" style={{ width: `${progress.progress_percentage}%` }}></div>
                </div>
                <p className="text-xs text-muted-foreground mt-1">{progress.progress_percentage}% complete</p>
              </div>
            )}
          </CardContent>
          <CardFooter className="flex justify-between">
            <Button onClick={handleUpdateProgress}>{progress ? "Continue Learning" : "Start Learning"}</Button>
          ...
          <div className="space-y-4 animate-fade-in" style={{ animationDelay: "0.2s" }}>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  This quiz contains {questions.length} questions. Answer all questions to complete the quiz.
                </CardDescription>
              </CardHeader>
              <CardContent>
